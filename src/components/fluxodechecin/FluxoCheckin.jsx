...
const etapas = [
        {
            titulo: "Validar bilhete",
            hora: "14:50",
            estado: "concluido"
        },
        {
            titulo: "Registrar bagagem",
            hora: "15:00",
            estado: "concluido"
        },
        {
            titulo: "Verificar overbooking",
            hora: "14:50",
            estado: "ativo"
        },
        {
            titulo: "Emitir cartão embarque",
            hora: "15:00",
            estado: "concluido"
        },
        {
            titulo: "Liberação para embarque",
            hora: "",
            estado: "concluido"
        }
    ]
                    ...
                    <div className={`fluxo-item ${etapa.estado}`} key={index}>
                        ...
                        <div className="fluxo-conteudo">
                            ...
                            <p>
                                ...
                                {etapa.estado === "ativo" && `ativo ${etapa.hora}`}
